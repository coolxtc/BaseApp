...
//    private static int restartCount = 0;
    ...
    public void init(Context context) {
        mContext = context;
//        restartCount = StrUtil.str2Int(UserInfoModel.getRestart());
...
//                Intent intent = new Intent(mContext,LancherActivity_.class);
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                String path = App.instance.getExternalFilesDir(null) + Constant.APK_CRASH_PATH;
